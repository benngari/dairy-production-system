  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-4 rounded shadow mb-6 grid grid-cols-3 gap-4">
        ...
        <input type="text" placeholder="Unit" value={form.unit} onChange={(e) => setForm({...form, unit: e.target.value})} className="border p-2 rounded" required />
        ...
        <button type="submit" className="col-span-3 bg-green-600 text-white px-4 py-2 rounded">{editing ? 'Update' : 'Add'} Ingredient</button>
      </form>
